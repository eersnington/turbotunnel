export const TURBOTUNNEL_VERSION = "0.0.2";
...
export const PRESENCE_EVENT_TTL_SECONDS = 60;
export const PRESENCE_LEASE_WINDOW_MS = 30_000;
export const PRESENCE_TOPIC = "tt_presence_v1";
export const PRESENCE_RECEIVE_LIMIT = 10;
export const PRESENCE_REPLAY_EVENT_LIMIT = 10_000;
export const PRESENCE_VISIBILITY_TIMEOUT_SECONDS = 30;
