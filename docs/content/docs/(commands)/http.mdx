...
`tt http` opens a tunnel to a local app through the configured gateway. The app can start before or after the tunnel. For task guides, see [use cases](/docs/use-cases).
