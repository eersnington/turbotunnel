...
`tt http` opens a tunnel to a local app through the configured gateway. The app can start before or after the tunnel. For goal-oriented workflows, see [use cases](/docs/use-cases).
...
| `--slug <slug>`      | Public tunnel slug. Use lowercase letters, digits, and hyphens; maximum 54 characters. | Saved slug or a random slug    |
